...
<template>
	...
	<Toolbar v-if="$route.name === 'profile'" color="primary-darken-1" :actions="['partnered']" :breadcrumb="breadcrumb" :is-loading="authIsLoading" main :partnered="item" @partner="partner(inputs)" @cancel-partner="cancelPartner(inputs)" />
